...
public class Db2GpkgTest {
    ...
    // Es soll keine Fehlermeldung ausgegeben werden, wenn 1 Reihe der Tabelle in
    // eine Gpkg-Datei geschrieben wird.
    ...
    public void export_SingleRow_Ok() throws Exception {
        ...
        try {
            pgConnection = DriverManager.getConnection(postgres.getJdbcUrl(), postgres.getUsername(),
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.gpkgexport(attr character varying,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.gpkgexport(attr,the_geom) VALUES ('coord2d','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_SchemaNotSet_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE defaultgpkgexport(attr character varying,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO defaultgpkgexport(attr,the_geom) VALUES ('coord2d','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_FindTableInDefinedSchema_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.defaultgpkgexport(attr character varying,the_geom geometry(POINT,2056));");
                preStmt.execute(
                        "CREATE TABLE defaultgpkgexport(attr character varying,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.defaultgpkgexport(attr,the_geom) VALUES ('coord2d','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    // richtigen Format in die Gpkg-Datei exportiert wurde.
    // - set: database-dbtogpkgschema
    // - set: database-table
    // --
    ...
    public void export_Datatype_BigInt_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr bigint,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('9223372036854775807','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Boolean_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr boolean,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('true','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Bit_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('1','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Bit1_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr bit(1),the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES (B'1','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Bit3_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr bit(3),the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES (B'101','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Char_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('a','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_VarChar_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('abc','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Date_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('2017-02-15','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Date_Null_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE TABLE dbtogpkgschema.exportdatatype(attr date,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES (NULL,'0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_SomeDataTypes_Null_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, attr2 bit, attr3 numeric, attr4 date, the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,attr2,attr3,attr4,the_geom) VALUES (NULL,NULL,NULL,NULL,NULL)");
                preStmt.close();
            }
            {
                if (data.exists()) {
            ...
            }
            {
                ...
                try {
                    ...
                    stmt = gpkgConnection.createStatement();
                    rs = stmt
                            .executeQuery("SELECT attr,attr2,attr3,attr4,the_geom FROM export_datatype_datatypes_null");
                    while (rs.next()) {
                        assertEquals(null, rs.getObject(1));
    ...
    public void export_Datatype_Integer_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr integer,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES (12,'0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Numeric_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr numeric,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES (123,'0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('character varying','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Smallint_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr smallint,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES (5,'0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Timestamp_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr timestamp,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('2014-05-15 12:30:30.555','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Uuid_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('123e4567-e89b-12d3-a456-426655440000','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Xml_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('<attrText>character varying</attrText>','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('coord2d','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_Point3d_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(POINTZ,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('coord3d','01010000a0080800001cd4411dd441cdbf0e69626cdd33e23fb0726891ed7cbf3f')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_MultiPoint2d_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(MULTIPOINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('multicoord2d','0104000020080800000300000001010000001CD4411DD441CDBF0E69626CDD33E23F010100000074CFC8D2439AC8BF9E91A5873431E63F01010000006668E3AA7F40DFBFF094204F09F2D43F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
            ...
            }
            {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        IomObject iomGeom = gpkg2iox.read(rs.getBytes(2));
                        assertEquals(
                                "MULTICOORD {coord [COORD {C1 -0.22857142857142854, C2 0.5688311688311687}, COORD {C1 -0.19220779220779216, C2 0.6935064935064934}, COORD {C1 -0.48831168831168836, C2 0.32727272727272716}]}",
                                iomGeom.toString());
                    }
                    rs.close();
                    stmt.close();
    ...
    public void export_Datatype_MultiPoint3d_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(MULTIPOINTZ,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('multicoord3d','01040000a0080800000300000001010000801bd4411dd441cdbf0e69626cdd33e23f9a9999999999b93f010100008075cfc8d2439ac8bf9e91a5873431e63f9a9999999999c93f01010000806768e3aa7f40dfbff194204f09f2d43f333333333333d33f')");
                preStmt.close();
            }
            {
                if (data.exists()) {
            ...
            }
            {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        IomObject iomGeom = gpkg2iox.read(rs.getBytes(2));
                        assertEquals(
                                "MULTICOORD {coord [COORD {C1 -0.2285714285714285, C2 0.5688311688311687, C3 0.1}, COORD {C1 -0.1922077922077922, C2 0.6935064935064934, C3 0.2}, COORD {C1 -0.4883116883116884, C2 0.3272727272727272, C3 0.3}]}",
                                iomGeom.toString());
                    }
                    rs.close();
                    stmt.close();
    ...
    public void export_Datatype_LineString_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(LINESTRING,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('linestring','010200002008080000020000001CD4411DD441CDBF0E69626CDD33E23F202A504A86DFCCBF8FFEA5F7491BE23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
            ...
            }
            {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        IomObject iomGeom = gpkg2iox.read(rs.getBytes(2));
                        assertEquals(
                                "POLYLINE {sequence SEGMENTS {segment [COORD {C1 -0.22857142857142854, C2 0.5688311688311687}, COORD {C1 -0.22557142857142853, C2 0.5658311688311687}]}}",
                                iomGeom.toString());
                    }
                    rs.close();
                    stmt.close();
    ...
    public void export_Datatype_MultiLineString_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(MULTILINESTRING,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('multilinestring','010500002008080000020000000102000000020000001CD4411DD441CDBF0E69626CDD33E23F202A504A86DFCCBF8FFEA5F7491BE23F010200000002000000202A504A86DFCCBF8FFEA5F7491BE23FADA9EFBB6720CDBF981603D666C9E13F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
            ...
            }
            {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        IomObject iomGeom = gpkg2iox.read(rs.getBytes(2));
                        assertEquals(
                                "MULTIPOLYLINE {polyline [POLYLINE {sequence SEGMENTS {segment [COORD {C1 -0.22857142857142854, C2 0.5688311688311687}, COORD {C1 -0.22557142857142853, C2 0.5658311688311687}]}}, POLYLINE {sequence SEGMENTS {segment [COORD {C1 -0.22557142857142853, C2 0.5658311688311687}, COORD {C1 -0.22755142857142854, C2 0.5558351688311687}]}}]}",
                                iomGeom.toString());
                    }
                    rs.close();
                    stmt.close();
    ...
    public void export_Datatype_Polygon_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(POLYGON,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('polygon','01030000200808000001000000060000001CD4411DD441CDBF0E69626CDD33E23F26ABE58D114CC4BFB2D99F76B4D7E23F26ABE58D114CC4BFB2D99F76B4D7E23F26ABE58D114CC4BF0E69626CDD33E23F26ABE58D114CC4BF0E69626CDD33E23F1CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
    ...
    public void export_Datatype_MultiPolygon_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportdatatype(attr character varying, the_geom geometry(MULTIPOLYGON,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportdatatype(attr,the_geom) VALUES ('multipolygon','0106000020080800000100000001030000000100000006000000C976BE9F1A2FCDBF931804560E2DE23FD34D62105839C4BF37894160E5D0E23FD34D62105839C4BF37894160E5D0E23FD34D62105839C4BF931804560E2DE23FD34D62105839C4BF931804560E2DE23FC976BE9F1A2FCDBF931804560E2DE23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
            ...
            }
            {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        IomObject iomGeom = gpkg2iox.read(rs.getBytes(2));
                        assertEquals(
                                "MULTISURFACE {surface SURFACE {boundary BOUNDARY {polyline POLYLINE {sequence SEGMENTS {segment [COORD {C1 -0.228, C2 0.568}, COORD {C1 -0.158, C2 0.588}, COORD {C1 -0.158, C2 0.588}, COORD {C1 -0.158, C2 0.568}, COORD {C1 -0.158, C2 0.568}, COORD {C1 -0.228, C2 0.568}]}}}}}",
                                iomGeom.toString());
                    }
                    rs.close();
                    stmt.close();
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.gpkgexport(attr character varying,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.gpkgexport(attr,the_geom) VALUES ('abc','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
    ...
    public void export_MultipleGeometryColumns_Fail() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportgpkg(attr character varying, the_point geometry(POINT,2056), the_other_point geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportgpkg(attr,the_point,the_other_point) VALUES ('fubar','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            if (data.exists()) {
                data.delete();
    ...
    public void export_MultipleGeometryColumns2_Fail() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exportgpkg(attr character varying, the_point geometry(POINT,2056), the_linestring geometry(LINESTRING,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exportgpkg(attr,the_point,the_linestring) VALUES ('fubar','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F','010200002008080000020000001CD4411DD441CDBF0E69626CDD33E23F202A504A86DFCCBF8FFEA5F7491BE23F')");
                preStmt.close();
            }
            if (data.exists()) {
                data.delete();
    ...
    public void export_twoTables_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA dbtogpkgschema");
                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exporttable1(attr integer,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exporttable1(attr,the_geom) VALUES (1,'0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");

                preStmt.execute(
                        "CREATE TABLE dbtogpkgschema.exporttable2(attr integer,the_geom geometry(POINT,2056));");
                preStmt.executeUpdate(
                        "INSERT INTO dbtogpkgschema.exporttable2(attr,the_geom) VALUES (2,'0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                if (data.exists()) {
