...
public class Db2CsvTest {
    ...
    public void export_SingleRow_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtocsvschema.csvexportnopk(idname character varying, abbreviation character varying, state character varying) WITH (OIDS=FALSE);");
                // import data to table
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.csvexportnopk (idname, abbreviation, state) VALUES ('10', 'CH', 'Schweiz')");
                preStmt.close();
            }
            {
                // csv
    ...
    // Es soll keine Fehlermeldung ausgegeben werden, wenn 10 Tabellenspalten aus
    // einer Tabelle in eine Csv-Datei exportiert werden.
        ...
        try {
            ...
            }
            {
                ...
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_10ColumnNames_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // Es soll keine Fehlermeldung ausgegeben werden, wenn der Delimiter vom
    // Benutzer aus gesetzt wird.
    // Die Test-Konfiguration wird wie folgt gesetzt:
    // - set: database-dbtocsvschema
    // - set: database-table
    // - set: delimiter
    ...
    public void export_SetDelimiter_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_SetDelimiter_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // Es soll keine Fehlermeldung ausgegeben werden, wenn der Record-Delimiter vom
    // Benutzer aus gesetzt wird.
    // Die Test-Konfiguration wird wie folgt gesetzt:
    // - set: database-dbtocsvschema
    // - set: database-table
    ...
    public void export_SetRecordDelimiter_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_SetRecordDelimiter_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // Es soll keine Fehlermeldung ausgegeben werden, wenn der Delimiter und der
    // Record-Delimiter vom Benutzer gesetzt wird.
    // Die Test-Konfiguration wird wie folgt gesetzt:
    // - set: database-dbtocsvschema
    // - set: database-table
    // - set: delimiter
    ...
    public void export_SetDelimiterAndRecordDelimiter_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_SetDelimiterAndRecordDelimiter_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // Es soll keine Fehlermeldung ausgegeben werden, da beim Setzen des Headers
    // immer present gesetzt wird.
    // - set: database-dbtocsvschema
    // - set: database-table
    // - set: header --> absent
    // --
    ...
    public void export_HeaderAbsent_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_HeaderAbsent_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // Es soll keine Fehlermeldung ausgegeben werden, wenn mehrere Reihen innerhalb
    // der Datenbank Tabelle definiert sind.
    // Die Test-Konfiguration wird wie folgt gesetzt:
    // - set: database-dbtocsvschema
    // - set: database-table
    // --
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.csvexportnopk (idname, abbreviation, state) VALUES ('10', 'CH', 'Schweiz')");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.csvexportnopk (idname, abbreviation, state) VALUES ('11', 'DE', 'Deutschland')");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.csvexportnopk (idname, abbreviation, state) VALUES ('12', 'FR', 'Frankreich')");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.csvexportnopk (idname, abbreviation, state) VALUES ('13', 'IT', 'Italien')");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.csvexportnopk (idname, abbreviation, state) VALUES ('14', 'ES', 'Spanien')");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.csvexportnopk (idname, abbreviation, state) VALUES ('15', 'AT', 'Oesterreich')");
                preStmt.close();
            }
            {
                // csv
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_MultipleRows_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_SchemaNotSet_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table
                preStmt.execute(
                        "CREATE TABLE defaultcsvexportnopk(idname character varying, abbreviation character varying, state character varying) WITH (OIDS=FALSE);");
                // import data to table
                preStmt.executeUpdate(
                        "INSERT INTO defaultcsvexportnopk (idname, abbreviation, state) VALUES ('S_10', 'S_CH', 'S_Schweiz')");
                preStmt.close();
            }
            {
                // csv
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_SchemaNotSet_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE defaultcsvexportnopk(idname character varying, abbreviation character varying, state character varying) WITH (OIDS=FALSE);");
                preStmt.execute(
                        "CREATE TABLE dbtocsvschema.defaultcsvexportnopk(idname character varying, abbreviation character varying, state character varying) WITH (OIDS=FALSE);");
                // import data to table
                preStmt.executeUpdate(
                        "INSERT INTO defaultcsvexportnopk (idname, abbreviation, state) VALUES ('D_10', 'D_CH', 'D_Schweiz')");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.defaultcsvexportnopk (idname, abbreviation, state) VALUES ('S_10', 'S_CH', 'S_Schweiz')");
                preStmt.close();
            }
            // csv
            ...
            db2Csv.exportData(data, jdbcConnection, config);
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_FindTableInDefinedSchema_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_FindTableInDefaultSchema_Ok() throws Exception {
        ...
        try {
            ...
            db2Csv.exportData(data, jdbcConnection, config);
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_FindTableInDefaultSchema_Ok.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // richtigen Format in die CSV Datei exportiert wurde.
    // - set: header-present
    // - set: database-dbtocsvschema
    // - set: database-table
    // --
    ...
    public void export_Datatype_BigInt_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeBigint.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_Boolean_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeBoolean.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_VarChar_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeVarchar.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // Es wird getestet, ob das Date auf das definierte Format geprueft wird und das
    // Date im richtigen Format in die Csv-Datei geschrieben wird.
    // - set: header-present
    // - set: database-dbtocsvschema
    // - set: database-table
    // - set: date-format
    ...
    public void export_Datatype_Date_DateFormat_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeDate_DateFormat.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_Integer_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeInteger.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_Numeric_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeNumeric.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_Time_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in dbtocsvschema
                preStmt.execute(
                        "CREATE TABLE dbtocsvschema.exportdatatype(attr time without time zone) WITH (OIDS=FALSE);");
    ...
    // Time im richtigen Format in die Csv-Datei geschrieben wird.
    // - set: header-present
    // - set: database-dbtocsvschema
    // - set: time-format
    // --
    ...
    public void export_Datatype_Time_TimeFormat_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeTime_TimeFormat.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_Smallint_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeSmallint.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_Timestamp_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in dbtocsvschema
                preStmt.execute(
                        "CREATE TABLE dbtocsvschema.exportdatatype(attr timestamp without time zone) WITH (OIDS=FALSE);");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.exportdatatype (attr) VALUES ('2014-05-15 12:30:40.555')");
                preStmt.close();
            }
            {
                // csv
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeTimestamp.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    // und den TimeStamp im richtigen Format in die Csv-Datei geschrieben wird.
    // - set: header-present
    // - set: database-dbtocsvschema
    // - set: database-table
    ...
    public void export_Datatype_Timestamp_TimeStampFormat_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeTimestamp_TimeStampFormat.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
    ...
    public void export_Datatype_Uuid_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.exportdatatype (attr) VALUES ('123e4567-e89b-12d3-a456-426655440000')");
                preStmt.close();
            }
            {
                // csv
    ...
    public void export_Datatype_Xml_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.exportdatatype (attr) VALUES ('<attrText>character varying</attrText>')");
                preStmt.close();
            }
            {
                // csv
    ...
    public void export_SomeDataTypes_NoValueDefined_SetFirstLineAsValue_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE dbtocsvschema.exportdatatype(attr character varying, attr2 bit, attr3 numeric, attr4 date, attr5 time)");
                preStmt.executeUpdate(
                        "INSERT INTO dbtocsvschema.exportdatatype(attr,attr2,attr3,attr4,attr5) VALUES (NULL,NULL,NULL,NULL,NULL)");
                preStmt.close();
            }
            {
                // csv
            ...
            }
            {
                // Open the file for reading
                BufferedReader br = new BufferedReader(
                        new FileReader(new File(TEST_OUT + "export_DataTypeDateNull.csv")));
                String line = null;
                int lineIndex = 0;
                while ((line = br.readLine()) != null) {
                    lineIndex += 1;
