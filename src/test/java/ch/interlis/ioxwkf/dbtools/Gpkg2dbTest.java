    ...
    public void import_Point_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, idname character varying, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
            ...
            }
            {
                ...
                ResultSet rowCount = stmt
                        .executeQuery("SELECT COUNT(*) AS rowcount FROM gpkgtodbschema.gpkgimporttable;");
                while (rowCount.next()) {
                    assertEquals(1, rowCount.getInt(1));
                }
                ResultSet rs = stmt
                        .executeQuery("SELECT fid,idname,st_asewkt(geom) FROM gpkgtodbschema.gpkgimporttable;");
    ...
    public void import_LineString_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer,idname character varying,geom geometry(LINESTRING,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_MultiLineString_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer,idname character varying,geom geometry(MULTILINESTRING,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Polygon_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer,idname character varying,geom geometry(POLYGON,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
    ...
    public void import_MultiPolygon_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer,idname character varying,geom geometry(MULTIPOLYGON,2056))");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_SchemaNotSet_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE gpkgmportnoschematable(fid integer,idname character varying NOT NULL,geom geometry(POINT,2056),CONSTRAINT gpkgimporttable_pkey PRIMARY KEY (idname))");
                preStmt.close();
            }
            {
                File data = new File(TEST_IN, "Point.gpkg");
    ...
    public void import_Datatype_BigInt_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer,attr bigint,geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
            ...
            }
            {
                ...
                ResultSet rs = stmt
                        .executeQuery("SELECT fid,attr,st_asewkt(geom) FROM gpkgtodbschema.gpkgimporttable;");
                ResultSetMetaData rsmd = rs.getMetaData();
                assertEquals(3, rsmd.getColumnCount());
                while (rs.next()) {
    ...
    public void import_Datatype_Bit_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr boolean, geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Boolean_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr boolean, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Char_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr character, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_VarChar_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr character varying, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Date_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer,attr date, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Integer_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr integer, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Numeric_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr numeric, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Time_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer,attr time without time zone, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Smallint_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr smallint, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Timestamp_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr1 timestamp, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
            ...
            }
            {
                ...
                ResultSet rs = stmt
                        .executeQuery("SELECT fid,attr1,st_asewkt(geom) FROM gpkgtodbschema.gpkgimporttable;");
                ResultSetMetaData rsmd = rs.getMetaData();
                assertEquals(3, rsmd.getColumnCount());
                while (rs.next()) {
    ...
    public void import_Datatype_Uuid_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr uuid, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_Datatype_Xml_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute("CREATE SCHEMA gpkgtodbschema");
                preStmt.execute(
                        "CREATE TABLE gpkgtodbschema.gpkgimporttable(fid integer, attr xml, geom geometry(POINT,2056))");
                preStmt.close();
            }
            {
    ...
    public void import_UniqueConstraint_Fail() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE gpkgimportunique(fid integer, attr boolean NOT NULL,geom geometry(POINT,2056),CONSTRAINT gpkgimportunique_pkey PRIMARY KEY (attr))");
                preStmt.executeUpdate(
                        "INSERT INTO gpkgimportunique(attr,geom) VALUES ('TRUE','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                File data = new File(TEST_IN, "DataTypeBoolean.gpkg");
