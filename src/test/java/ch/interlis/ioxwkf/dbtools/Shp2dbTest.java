...
public class Shp2dbTest {
    ...
    public void import_Point_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(idname character varying,geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
            ...
            }
            {
                ...
                ResultSet rowCount = stmt
                        .executeQuery("SELECT COUNT(*) AS rowcount FROM shptodbschema.shpimporttable;");
                while (rowCount.next()) {
    ...
    public void import_MultiPoint_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(idname character varying,the_geom geometry(MULTIPOINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
            ...
            }
            {
                ...
                ResultSet rs = stmt
                        .executeQuery("SELECT idname,st_asewkt(the_geom) FROM shptodbschema.shpimporttable;");
                ResultSetMetaData rsmd = rs.getMetaData();
                assertEquals(2, rsmd.getColumnCount());
                while (rs.next()) {
                    assertEquals("12", rs.getObject(1));
                    assertEquals(
                            "SRID=2056;MULTIPOINT(-0.228571428571429 0.568831168831169,-0.192207792207792 0.693506493506493,-0.488311688311688 0.327272727272727)",
                            rs.getObject(2));
                }
            }
        } finally {
    ...
    public void import_LineString_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(idname character varying,the_geom geometry(LINESTRING,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
            ...
            }
            {
                ...
                while (rs.next()) {
                    assertEquals("12", rs.getObject(1));
                    assertEquals(
                            "SRID=2056;LINESTRING(-0.228571428571429 0.568831168831169,-0.225571428571429 0.565831168831169)",
                            rs.getObject(2));
                }
            }
        } finally {
    ...
    public void import_MultiLineString_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(idname character varying,the_geom geometry(MULTILINESTRING,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
            ...
            }
            {
                ...
                while (rs.next()) {
                    assertEquals("12", rs.getObject(1));
                    assertEquals(
                            "SRID=2056;MULTILINESTRING((-0.228571428571429 0.568831168831169,-0.225571428571429 0.565831168831169),(-0.225571428571429 0.565831168831169,-0.227551428571429 0.555835168831169))",
                            rs.getObject(2));
                }
            }
        } finally {
    ...
    public void import_Polygon_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(idname character varying,the_geom geometry(POLYGON,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
            ...
            }
            {
                ...
                while (rs.next()) {
                    assertEquals("12", rs.getObject(1));
                    assertEquals(
                            "SRID=2056;POLYGON((-0.228571428571429 0.568831168831169,-0.158571428571429 0.588831168831169,-0.158571428571429 0.588831168831169,-0.158571428571429 0.568831168831169,-0.158571428571429 0.568831168831169,-0.228571428571429 0.568831168831169))",
                            rs.getObject(2));
                }
            }
        } finally {
    ...
    public void import_MultiPolygon_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(idname character varying,the_geom geometry(MULTIPOLYGON,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
            ...
            }
            {
                ...
                while (rs.next()) {
                    assertEquals("12", rs.getObject(1));
                    assertTrue(rs.getObject(2).equals(
                            "SRID=2056;MULTIPOLYGON(((-0.228 0.568,-0.158 0.588,-0.158 0.588,-0.158 0.568,-0.158 0.568,-0.228 0.568)))")
                            || (rs.getObject(2).equals(
                                    "SRID=2056;MULTIPOLYGON(((0.228 1.3,0.158 0.5,0.158 0.5,0.158 1.568,0.158 1.568,0.228 1.3)))")));
                }
            }
        } finally {
            if (jdbcConnection != null) {
    ...
    // Testet ob der Import eines Linestring's in die Datenbank funktioniert,
    // wenn das datenbank-schema nicht gesetzt wird und die Test-Konfiguration wie
    // folgt gesetzt wird:
    ...
    public void import_SchemaNotSet_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shpimportnoschematable(idname character varying NOT NULL,the_geom geometry(POINT,2056),CONSTRAINT shpimporttable_pkey PRIMARY KEY (idname)) WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    // Es wird getestet, ob der richtige Datentyp innerhalb der Datenbank-Tabelle
    // importiert wurde.
    // - set: database-schema
    // - set: database-table
    // --
    ...
    public void import_Datatype_BigInt_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr bigint,the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Bit_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr boolean, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Char_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr character, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_attrName_similar_Ok() throws Exception {
        ...
        try {
            ...
            }
            {
                ...
                ResultSet rs = stmt
                        .executeQuery("SELECT \"Attr\",st_asewkt(the_geom) FROM shptodbschema.shpimporttable;");
                ResultSetMetaData rsmd = rs.getMetaData();
                assertEquals(2, rsmd.getColumnCount());
                while (rs.next()) {
                    assertEquals("a", rs.getObject(1));
    ...
    public void import_Datatype_VarChar_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr character varying, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Date_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr date, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    // Date im richtigen Format in die Datenbank schreibt.
    // - set: header-present
    // - set: database-schema
    // - set: database-table
    // - set: date-format
    ...
    public void import_Datatype_Date_DefinedFormat_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr1 date, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    // Wenn das Datum: 2017-Dez-20 erstellt wird, so muss innerhalb der DB,
    // 2017-12-20 importiert sein.
    // - set: header-present
    // - set: database-schema
    // - set: database-table
    // - set: date-format
    ...
    public void import_Datatype_Integer_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr integer, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Numeric_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr numeric, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Time_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr time without time zone, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    // Time im richtigen Format in die Datenbank geschrieben wird.
    // - set: header-present
    // - set: database-schema
    // - set: database-table
    // - set: date-format
    ...
    public void import_Datatype_Time_DefinedFormat_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr1 time without time zone, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Smallint_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr smallint, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Timestamp_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr1 timestamp, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    // und den TimeStamp im richtigen Format in die Datenbank schreibt.
    // - set: header-present
    // - set: database-schema
    // - set: database-table
    // - set: date-format
    ...
    public void import_Datatype_Uuid_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr uuid, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    public void import_Datatype_Xml_Ok() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shptodbschema.shpimporttable(attr xml, the_geom geometry(POINT,2056))WITH (OIDS=FALSE)");
                preStmt.close();
            }
            {
                // shp
    ...
    // Das Dateformat in den Settings ist ungueltig, es muss die folgende
    ...
    public void import_UniqueConstraint_Fail() throws Exception {
        ...
        try {
                    ...
                    postgres.getPassword());
            {
                ...
                // create table in schema
                preStmt.execute(
                        "CREATE TABLE shpimportunique(attr boolean NOT NULL,the_geom geometry(POINT,2056),CONSTRAINT shpimportunique_pkey PRIMARY KEY (attr)) WITH (OIDS=FALSE)");
                preStmt.executeUpdate(
                        "INSERT INTO shpimportunique(attr,the_geom) VALUES ('TRUE','0101000020080800001CD4411DD441CDBF0E69626CDD33E23F')");
                preStmt.close();
            }
            {
                // shp
